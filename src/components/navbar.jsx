                ...
                <div className="container">
                    ...
                    <div className="collapse navbar-collapse" id="site-nav">
                        <ul className="navbar-nav ml-auto">
                            <li className="nav-item active"><a href="#section-home" className="nav-link">Accueil</a></li>
                            <li className="nav-item"><a href="#section-about" className="nav-link">Infos</a></li>
                            <li className="nav-item"><a href="#section-gallery" className="nav-link">Photos</a></li>
                            ...
                            <li className="nav-item"><div className="nav-link dropdown show">
                                ...
                                <div className="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    ...
                                    <a className="dropdown-item" target="_blank" href="pdf/drink_2020.pdf">Cartes Des Boisson</a>
                                    <a className="dropdown-item" target="_blank" href="pdf/wine_2020.pdf">Cartes Des Vins</a>
                                </div>
                            </div></li>
                        </ul>
                    </div>

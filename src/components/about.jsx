                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-5 site-animate mb-5 ml-auto text-left">
                            ...
                            <p className="text-black"><b>Lundi-Mardi-Mercredi</b><br></br>17h00-21h00<br></br><b>Jeudi-Vendredi-Samedi-Dimanche</b><br></br>17h00-22h00</p>
                            <a href="https://www.facebook.com/tenrestaurantmontreal" target="_blank"><button type="button" onclick="https://www.facebook.com/tenrestaurantmontreal" className="btn btn-fb text-font-button"><i className="fab fa-facebook-f pr-1"></i> Facebook</button>
                            </a></div>
                    </div>
                </div>
            </section >
